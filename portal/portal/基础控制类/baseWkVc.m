...
-(void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context
{
    if (object == self.webView && [keyPath isEqualToString:@"estimatedProgress"] ) {
        ...
        NSLog(@"%@",self.webView.URL.absoluteString);
        if ([self.webView.title rangeOfString:@"."].location == NSNotFound && self.webView.title.length && ![self.webView.URL.absoluteString containsString:@"http://m.haidaowang.com/index.html#back_flag"]) {
