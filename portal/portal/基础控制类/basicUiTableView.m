...
//            kWeakSelf(self);
//            return [tableView fd_heightForCellWithIdentifier:NSStringFromClass([cell class]) configuration:^(UITableViewCell *cell) {
//                NSString *method =[NSString stringWithFormat:@"configure%@",NSStringFromClass([cell class])];
//                SEL selector = NSSelectorFromString(method);
//                if ([weakself respondsToSelector:selector]) {
//                    [weakself performSelector:selector withObject:tableView withObject:indexPath];
//                }
//            }];
//        }
//    }
